<template>
<div class="addHoseForm">
  <el-form  :model="house" class="login_box" :rules="houseRules" ref="addHouseForm">
    ...
    <el-form-item class="btns">
      <el-button type="primary" @click="addHouse('addHouseForm')">发 布 房 源</el-button>
      <el-button type="info" @click="resetForm('addHouseForm')">重 置</el-button>
    </el-form-item>
  </el-form>
</div>
</template>
  ...
  let pca = require('@/assets/pca-code1.json')
    export default {
      ...
      methods: {
        ...
        success (){
          this.$message.success("添加房源信息成功")
          this.$router.go(0)
        },
        fail(){
          this.$message.error("添加房源信息失败")
        },
        resetForm(formName) {
